          ...
          messages: [
            {
              ...
              content:
                opts.system ??
                "You are a precise personal brainlog assistant. Follow format instructions exactly. When asked for JSON, reply with ONLY a single JSON object — no markdown fences, no preamble, no trailing commentary.",
            },
