...
Brainlogs stores capture, mail snippets, and secrets on the machine that runs it. Treat any issue that lets **other websites or processes** read `127.0.0.1:3000` as high severity.
